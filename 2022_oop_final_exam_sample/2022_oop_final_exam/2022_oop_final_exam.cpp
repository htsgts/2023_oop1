/// 2022_oop_final_exam.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
///
...
int main()
{
	...
	for (i = 0; i < GAME_ROUND; i++)
	{
		...
		/// 게임 결과 출력
		game.printGameResult(i, result, userValue, computerValue);
		/// 게임 횟수 누적
		gameCnt++;
	}
